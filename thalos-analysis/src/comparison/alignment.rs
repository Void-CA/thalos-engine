...
//!
//! Resuelve qué punto del plan corresponde a cada punto de la ejecución,
//! incluso cuando las frecuencias de muestreo difieren. Trabaja sobre
//! [`TracePoint`](super::input::TracePoint): el input analítico neutral, no
//! sobre una representación de evidencia concreta.
...
/// Alinea el plan con la ejecución.
///
/// Estrategia: para cada punto del plan, interpola linealmente la
/// ejecución en el mismo timestamp. Así ambos quedan con la misma
/// referencia temporal.
pub fn align(plan_samples: &[TracePoint], exec_samples: &[TracePoint]) -> Alignment {
