...
use thalos_core::execution::ExecutionSource;

use crate::event::TelemetryLifecycleEvent;
...
pub struct ExecutionTrace {
    ...
    pub events: Vec<TelemetryLifecycleEvent>,
}
...
impl ExecutionTrace {
    ...
    /// Agregar un evento.
    pub fn push_event(&mut self, event: TelemetryLifecycleEvent) {
