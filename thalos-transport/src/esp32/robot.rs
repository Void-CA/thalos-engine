...
/// Physical ESP32 Robot Transport Adapter (ESP32 adapter).
///
...
///
/// This adapter is acceptable for physical integration because:
...
///
/// For production with many concurrent robots, consider the async-port option
